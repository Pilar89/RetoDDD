...
public class HuespedCreado extends DomainEvent {
  ...
  public HuespedCreado(HuespedId huespeId, Nombre nombre, Telefono telefono,
                       Direccion direccion, Correo corre){
    super("co.com.sofkau.gestionHuespede.HuespedCreado");
